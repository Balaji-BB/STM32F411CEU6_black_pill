...
#define DOWN_KEY_EXTI_IRQn EXTI0_IRQn
#define RIGHT_KEY_Pin GPIO_PIN_1
#define RIGHT_KEY_GPIO_Port GPIOA
#define RIGHT_KEY_EXTI_IRQn EXTI1_IRQn
#define CENTER_KEY_Pin GPIO_PIN_2
#define CENTER_KEY_GPIO_Port GPIOA
#define CENTER_KEY_EXTI_IRQn EXTI2_IRQn
#define LEFT_KEY_Pin GPIO_PIN_3
#define LEFT_KEY_GPIO_Port GPIOA
#define LEFT_KEY_EXTI_IRQn EXTI3_IRQn
